...
var ASM_CONSTS = {
	...
	160212: () => {
		return navigator.mediaDevices === undefined ? 0 : 1;
	},
	160271: ($0, $1, $2, $3, $4, $5, $6) => {
		const device = $0;
		const w = $1;
		const h = $2;
		...
		navigator.mediaDevices
			...
			.then((stream) => {
				...
				if (
					dynCall("iiiiii", outcome, [device, 1, actualw, actualh, actualfps])
				) {
	...
	164791: () => {
		return Module["SDL3"].audioContext.sampleRate;
	},
	164842: ($0, $1, $2, $3) => {
		var SDL3 = Module["SDL3"];
	...
	177928: ($0) => {
		...
		if (target) {
			...
			target.removeEventListener(
				"pointercancel",
				SDL3.eventHandlerPointerLeave,
			);
			target.removeEventListener(
				"pointerdown",
				SDL3.eventHandlerPointerGeneric,
			);
...
var _SDL_calloc = (Module["_SDL_calloc"] =
	makeInvalidEarlyAccess("_SDL_calloc"));
var _SDL_free = (Module["_SDL_free"] = makeInvalidEarlyAccess("_SDL_free"));
var _main = (Module["_main"] = makeInvalidEarlyAccess("_main"));
var _SDL_malloc = (Module["_SDL_malloc"] =
	makeInvalidEarlyAccess("_SDL_malloc"));
var _SDL_realloc = (Module["_SDL_realloc"] =
	makeInvalidEarlyAccess("_SDL_realloc"));
var _Emscripten_HandlePointerEnter = (Module["_Emscripten_HandlePointerEnter"] =
	makeInvalidEarlyAccess("_Emscripten_HandlePointerEnter"));
var _Emscripten_HandlePointerLeave = (Module["_Emscripten_HandlePointerLeave"] =
	makeInvalidEarlyAccess("_Emscripten_HandlePointerLeave"));
var _Emscripten_HandlePointerGeneric = (Module[
	"_Emscripten_HandlePointerGeneric"
] = makeInvalidEarlyAccess("_Emscripten_HandlePointerGeneric"));
var _Emscripten_SendDragEvent = (Module["_Emscripten_SendDragEvent"] =
	makeInvalidEarlyAccess("_Emscripten_SendDragEvent"));
var _Emscripten_SendDragCompleteEvent = (Module[
	"_Emscripten_SendDragCompleteEvent"
] = makeInvalidEarlyAccess("_Emscripten_SendDragCompleteEvent"));
var _Emscripten_SendDragTextEvent = (Module["_Emscripten_SendDragTextEvent"] =
	makeInvalidEarlyAccess("_Emscripten_SendDragTextEvent"));
var _Emscripten_SendDragFileEvent = (Module["_Emscripten_SendDragFileEvent"] =
	makeInvalidEarlyAccess("_Emscripten_SendDragFileEvent"));
var _Emscripten_SendSystemThemeChangedEvent = (Module[
	"_Emscripten_SendSystemThemeChangedEvent"
] = makeInvalidEarlyAccess("_Emscripten_SendSystemThemeChangedEvent"));
var _requestFullscreenThroughSDL = (Module["_requestFullscreenThroughSDL"] =
	makeInvalidEarlyAccess("_requestFullscreenThroughSDL"));
...
function assignWasmExports(wasmExports) {
	assert(
		typeof wasmExports["SDL_calloc"] != "undefined",
		"missing Wasm export: SDL_calloc",
	);
	assert(
		typeof wasmExports["SDL_free"] != "undefined",
		"missing Wasm export: SDL_free",
	);
	assert(
	...
	assert(
		typeof wasmExports["SDL_malloc"] != "undefined",
		"missing Wasm export: SDL_malloc",
	);
	assert(
		typeof wasmExports["SDL_realloc"] != "undefined",
		"missing Wasm export: SDL_realloc",
	);
	assert(
		typeof wasmExports["Emscripten_HandlePointerEnter"] != "undefined",
		"missing Wasm export: Emscripten_HandlePointerEnter",
	);
	assert(
		typeof wasmExports["Emscripten_HandlePointerLeave"] != "undefined",
		"missing Wasm export: Emscripten_HandlePointerLeave",
	);
	assert(
		typeof wasmExports["Emscripten_HandlePointerGeneric"] != "undefined",
		"missing Wasm export: Emscripten_HandlePointerGeneric",
	);
	assert(
		typeof wasmExports["Emscripten_SendDragEvent"] != "undefined",
		"missing Wasm export: Emscripten_SendDragEvent",
	);
	assert(
		typeof wasmExports["Emscripten_SendDragCompleteEvent"] != "undefined",
		"missing Wasm export: Emscripten_SendDragCompleteEvent",
	);
	assert(
		typeof wasmExports["Emscripten_SendDragTextEvent"] != "undefined",
		"missing Wasm export: Emscripten_SendDragTextEvent",
	);
	assert(
		typeof wasmExports["Emscripten_SendDragFileEvent"] != "undefined",
		"missing Wasm export: Emscripten_SendDragFileEvent",
	);
	assert(
		typeof wasmExports["Emscripten_SendSystemThemeChangedEvent"] != "undefined",
		"missing Wasm export: Emscripten_SendSystemThemeChangedEvent",
	);
	assert(
		typeof wasmExports["requestFullscreenThroughSDL"] != "undefined",
		"missing Wasm export: requestFullscreenThroughSDL",
	);
	assert(
	...
	_Emscripten_HandlePointerEnter = Module["_Emscripten_HandlePointerEnter"] =
		createExportWrapper("Emscripten_HandlePointerEnter", 2);
	_Emscripten_HandlePointerLeave = Module["_Emscripten_HandlePointerLeave"] =
		createExportWrapper("Emscripten_HandlePointerLeave", 2);
	_Emscripten_HandlePointerGeneric = Module[
		"_Emscripten_HandlePointerGeneric"
	] = createExportWrapper("Emscripten_HandlePointerGeneric", 2);
	_Emscripten_SendDragEvent = Module["_Emscripten_SendDragEvent"] =
		createExportWrapper("Emscripten_SendDragEvent", 2);
	_Emscripten_SendDragCompleteEvent = Module[
		"_Emscripten_SendDragCompleteEvent"
	] = createExportWrapper("Emscripten_SendDragCompleteEvent", 1);
	_Emscripten_SendDragTextEvent = Module["_Emscripten_SendDragTextEvent"] =
		createExportWrapper("Emscripten_SendDragTextEvent", 2);
	_Emscripten_SendDragFileEvent = Module["_Emscripten_SendDragFileEvent"] =
		createExportWrapper("Emscripten_SendDragFileEvent", 2);
	_Emscripten_SendSystemThemeChangedEvent = Module[
		"_Emscripten_SendSystemThemeChangedEvent"
	] = createExportWrapper("Emscripten_SendSystemThemeChangedEvent", 0);
	_requestFullscreenThroughSDL = Module["_requestFullscreenThroughSDL"] =
		createExportWrapper("requestFullscreenThroughSDL", 1);
